  ...
  return (
    <main className="flex flex-col items-center h-[100vh] p-4 mt-12">
      ...
      >
        ...
        <FormRow type="email" labelText="Email address" onChangeFunction={(e)=>{changeRegisterState('registerEmail',e.target.value)}}/>
        <FormRow type="password" labelText="Password" onChangeFunction={(e)=>{changeRegisterState('registerPassword',e.target.value)}}/>
        <ButtonComponent text={registerState.loading?<Loader/>:"Sign Up"} type="primary" />
      </form>
    </main>
  );
}
