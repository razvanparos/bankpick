...
function CardFront({ card, onClickFunction,cardColor="gray" }) {
  ...
  return (
    <section
      ...
      className={`w-full max-w-[420px] opacity-100 bg-${cardColor} bg-opacity-35 card-bg-img h-[222px] rounded-3xl p-5 flex flex-col justify-between bg-no-repeat bg-center cursor-pointer`}
    >
